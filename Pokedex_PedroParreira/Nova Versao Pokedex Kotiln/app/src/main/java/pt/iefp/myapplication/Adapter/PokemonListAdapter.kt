package pt.iefp.myapplication.Adapter
...
import pt.iefp.myapplication.PokemonList
import pt.iefp.myapplication.R
...
class PokemonListAdapter (internal var context: Context,
    ...
    init {img_pokemon = itemView.findViewById(R.id.pokemon_image) as ImageView
