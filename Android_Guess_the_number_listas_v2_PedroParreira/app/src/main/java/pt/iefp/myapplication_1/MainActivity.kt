...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val ranking = remember { mutableStateMapOf<Int, Int>() }
                    ...
                    Box(
                        ...
                        Button(
                            onClick = {
                                ...
                                if (tentativa != null) {
                                    ranking[tentativa] = (ranking[tentativa] ?: 0) + 1
                                    when {
                                        tentativa !in 1..10 -> {
            ...
            Column {
                Box(
                    ...
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        ...
                        if (ranking.isEmpty()) {
                            Text(text = "Sem palpites ainda.",
                                modifier = Modifier.padding(16.dp),
                                fontSize = 20.sp)
                        } else {
                            ranking.toList()
                                .sortedByDescending { it.second }
                                .forEach { (numero, contagem) ->
                                    Text(text = "Número $numero: $contagem vez(es)🏆",
                                        fontSize = 20.sp
